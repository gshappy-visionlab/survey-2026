...
const questions = [
  {
    ...
    groups: {
      cellGroup: {
        ...
        options: ["샤인(92~95또래)", "하모니(96~99또래)", "멜로디(00~03또래)", "조이(04~06또래) / 07또래"],
      },
      activities: {
...
const shareQuestions = [
  "복음을 전하고 싶은 대상이 있나요?",
  "복음을 전할 때의 가장 큰 걸림돌은 무엇인가요?",
  "복음을 전하고 있다면 복음을 전하게 된 계기나 간증이 있는지 나눠주세요.",
];
...
const resultContent = {
  ...
  witness: {
    ...
    copy: "복음을 전한 경험은 하나님께서 삶의 현장에서 일하고 계신 흔적입니다. 그 경험을 더 선명한 간증과 지속적인 순종으로 이어갈 수 있습니다.",
    actions: shareQuestions,
  },
  vision: {
